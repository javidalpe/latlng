...
exports.validateLat = validateLat;
exports.validateLng = validateLng;
function decimalLatToDegree(l) {
	var array = decimalToDegree(l);
	var str;
	if (l > 0) str = array[0] + "º " + array[1] + "' N";else str = array[0] + "º " + array[1] + "' S";

	if (array[0] < 10) str = '0' + str;
...
function decimalLngToDegree(l) {
	var array = decimalToDegree(l);
	var str;
	if (l > 0) str = array[0] + "º " + array[1] + "' E";else str = array[0] + "º " + array[1] + "' W";

	if (array[0] < 10) str = '00' + str;else if (array[0] < 100) str = '0' + str;
...
function validateLat(numberLat) {
	return inrange(-90, numberLat, 90);
}

function validateLng(numberLng) {
